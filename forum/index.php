...
<div class="container-fluid" style="//padding-top: 50px;">
    <div class="row" style="background: #f6ffc6; padding-top: 20px; padding-bottom: 20px;">
         <div class="col-lg-8 col-lg-offset-2" >
             <h2>Refer to the previous version <a href="http://idineth.com/eagle-circuits/forum/">http://idineth.com/eagle-circuits/forum/</a><br>
             Forum will be the same as the previous version</h2>
         </div>
     </div>
 </div>
<!-- -->
